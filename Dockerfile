...
ENV LANG C.UTF-8
RUN apt-get update && apt-get install -y composer git php-ast php-xml php-zip php-gd php-gmp php-mbstring php-curl python3 python3-pip python3-setuptools python3-wheel python3-requests --no-install-recommends && rm -rf /var/lib/apt/lists/*
